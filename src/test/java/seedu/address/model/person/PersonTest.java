...
public class PersonTest {
    ...
    public void isSamePerson() {
        ...
        Person editedAlice = new PersonBuilder(ALICE).withRating(VALID_RATING_BOB).withEmail(VALID_EMAIL_BOB).build();
        ...
        editedAlice = new PersonBuilder(ALICE).withRating(VALID_RATING_BOB).withAddress(VALID_ADDRESS_BOB)
                .withTags(VALID_TAG_HUSBAND).build();
        assertTrue(ALICE.isSamePerson(editedAlice));
